...
public class MenuMedico {
    ...
    public void mostrarMedicos() throws Exception {
        while (true) {
            ...
            System.out.println(
                    "\n1.Cadastrar 2.Alterar 3.Remover 4.Perquisar 5.Listar 6.Adicionar 5 médicos 7.Buscar por String 8.voltar\n\n");
            ...
            switch (opcao) {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    staff.adicionar5Medicos();
                    break;

                case 7:
                    System.out.println("\t\t*Buscar Médicos por nome selecionado*\n");
                    System.out.println("\nDigite o nome do médico que deseja buscar:");
                    String nomeBuscar = inputString.nextLine();
                    staff.buscarMedicosPorNome(nomeBuscar);
                    break;
                default:
